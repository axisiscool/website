    ...
    <div className="flex h-screen items-center justify-center bg-cream text-center dark:bg-slate-900">
      <div className="text-center">
        ...
        <div className="grid grid-cols-3 gap-2 pt-5 lg:gap-3">
          <Link href="/projects">
            <button className="rounded-lg bg-blue-400 p-2 px-6 text-center text-lg font-bold text-slate-800 shadow-md hover:bg-blue-500 dark:bg-blue-300 dark:shadow-lg dark:hover:bg-blue-400 md:px-8 lg:px-10">
              Projects
            </button>
          </Link>
